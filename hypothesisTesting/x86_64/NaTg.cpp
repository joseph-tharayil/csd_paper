 ...
 hoc_register_parm_default(_mechtype, &_parm_default);
  ...
  hoc_register_dparam_semantics(_mechtype, 5, "cvodeieq");
    ...
    hoc_register_var(hoc_scdoub, hoc_vdoub, hoc_intfunc);
 	ivoc_help("help ?1 NaTg /mnt/mydata/Documents/csdRevisions/csd_paper/hypothesisTesting/mods_dir/NaTg.mod\n");
...
static void register_nmodl_text_and_filename(int mech_type) {
    const char* nmodl_filename = "/mnt/mydata/Documents/csdRevisions/csd_paper/hypothesisTesting/mods_dir/NaTg.mod";
