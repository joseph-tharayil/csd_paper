  ...
  if (nrn_point_prop_) {
   ...
   _ppvar = nrn_prop_datum_alloc(_mechtype, 2, _prop);
    ...
    assert(_nrn_mechanism_get_num_vars(_prop) == 14);
 	...
 	rs = _parm_default[0]; /* 1 */
 	dur1 = _parm_default[1]; /* 0 */
 	amp1 = _parm_default[2]; /* 0 */
 	dur2 = _parm_default[3]; /* 0 */
 	amp2 = _parm_default[4]; /* 0 */
 	dur3 = _parm_default[5]; /* 0 */
 	amp3 = _parm_default[6]; /* 0 */
  }
 	 assert(_nrn_mechanism_get_num_vars(_prop) == 14);
 	_nrn_mechanism_access_dparam(_prop) = _ppvar;
 ...
 hoc_register_parm_default(_mechtype, &_parm_default);
  ...
  hoc_register_dparam_semantics(_mechtype, 1, "pntproc");
    ...
    hoc_register_var(hoc_scdoub, hoc_vdoub, hoc_intfunc);
 	ivoc_help("help ?1 ConductanceSource /mnt/mydata/Documents/csdRevisions/csd_paper/hypothesisTesting/mods_dir/ConductanceSource.mod\n");
...
static void register_nmodl_text_and_filename(int mech_type) {
    const char* nmodl_filename = "/mnt/mydata/Documents/csdRevisions/csd_paper/hypothesisTesting/mods_dir/ConductanceSource.mod";
