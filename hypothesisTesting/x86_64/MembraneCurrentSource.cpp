...
#define nrn_init _nrn_init__MembraneCurrentSource
#define _nrn_initial _nrn_initial__MembraneCurrentSource
#define nrn_cur _nrn_cur__MembraneCurrentSource
#define _nrn_current _nrn_current__MembraneCurrentSource
#define nrn_jacob _nrn_jacob__MembraneCurrentSource
#define nrn_state _nrn_state__MembraneCurrentSource
#define _net_receive _net_receive__MembraneCurrentSource 
  ...
  if (nrn_point_prop_) {
   ...
   _ppvar = nrn_prop_datum_alloc(_mechtype, 2, _prop);
    ...
    assert(_nrn_mechanism_get_num_vars(_prop) == 6);
 	...
 	del = _parm_default[0]; /* 0 */
 	dur = _parm_default[1]; /* 0 */
 	amp = _parm_default[2]; /* 0 */
  }
 	 assert(_nrn_mechanism_get_num_vars(_prop) == 6);
 	_nrn_mechanism_access_dparam(_prop) = _ppvar;
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 extern "C" void _MembraneCurrentSource_reg() {
	int _vectorized = 1;
  _initlists();
 ...
 hoc_register_parm_default(_mechtype, &_parm_default);
  ...
  hoc_register_dparam_semantics(_mechtype, 1, "pntproc");
    ...
    hoc_register_var(hoc_scdoub, hoc_vdoub, hoc_intfunc);
 	ivoc_help("help ?1 MembraneCurrentSource /mnt/mydata/Documents/csdRevisions/csd_paper/hypothesisTesting/mods_dir/MembraneCurrentSource.mod\n");
...
static void register_nmodl_text_and_filename(int mech_type) {
    const char* nmodl_filename = "/mnt/mydata/Documents/csdRevisions/csd_paper/hypothesisTesting/mods_dir/MembraneCurrentSource.mod";
