  ...
  Datum *_ppvar{};
   _ppvar = nrn_prop_datum_alloc(_mechtype, 6, _prop);
    ...
    assert(_nrn_mechanism_get_num_vars(_prop) == 24);
 	...
 	gNaTgbar = _parm_default[0]; /* 1e-05 */
 	vshifth = _parm_default[1]; /* -1 */
 	vshiftm = _parm_default[2]; /* 1 */
 	slopeh = _parm_default[3]; /* 7 */
 	slopem = _parm_default[4]; /* 7 */
 	 assert(_nrn_mechanism_get_num_vars(_prop) == 24);
 	_nrn_mechanism_access_dparam(_prop) = _ppvar;
 ...
 hoc_register_parm_default(_mechtype, &_parm_default);
  ...
  hoc_register_dparam_semantics(_mechtype, 5, "cvodeieq");
    ...
    hoc_register_var(hoc_scdoub, hoc_vdoub, hoc_intfunc);
 	ivoc_help("help ?1 NaTg_somadend /mnt/mydata/Documents/csdRevisions/csd_paper/hypothesisTesting/mods_dir/NaTg_somadend.mod\n");
...
static void register_nmodl_text_and_filename(int mech_type) {
    const char* nmodl_filename = "/mnt/mydata/Documents/csdRevisions/csd_paper/hypothesisTesting/mods_dir/NaTg_somadend.mod";
