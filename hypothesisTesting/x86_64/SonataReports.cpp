  ...
  if (nrn_point_prop_) {
   ...
   _ppvar = nrn_prop_datum_alloc(_mechtype, 3, _prop);
    ...
    assert(_nrn_mechanism_get_num_vars(_prop) == 4);
 	...
 	Dt = _parm_default[0]; /* 0.1 */
 	tstart = _parm_default[1]; /* 0 */
 	tstop = _parm_default[2]; /* 0 */
  }
 	 assert(_nrn_mechanism_get_num_vars(_prop) == 4);
 	_nrn_mechanism_access_dparam(_prop) = _ppvar;
 ...
 hoc_register_parm_default(_mechtype, &_parm_default);
  ...
  hoc_register_dparam_semantics(_mechtype, 2, "bbcorepointer");
    ...
    hoc_register_var(hoc_scdoub, hoc_vdoub, hoc_intfunc);
 	ivoc_help("help ?1 SonataReport /mnt/mydata/Documents/csdRevisions/csd_paper/hypothesisTesting/mods_dir/SonataReports.mod\n");
...
static void register_nmodl_text_and_filename(int mech_type) {
    const char* nmodl_filename = "/mnt/mydata/Documents/csdRevisions/csd_paper/hypothesisTesting/mods_dir/SonataReports.mod";
