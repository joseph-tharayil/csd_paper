...
#define toggleVerbose toggleVerbose__DetGABAAB 
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 8;
    ...
    hoc_register_var(hoc_scdoub, hoc_vdoub, hoc_intfunc);
 	ivoc_help("help ?1 DetGABAAB /mnt/mydata/Documents/csdRevisions/csd_paper/hypothesisTesting/mods_dir/DetGABAAB.mod\n");
...
static void register_nmodl_text_and_filename(int mech_type) {
    const char* nmodl_filename = "/mnt/mydata/Documents/csdRevisions/csd_paper/hypothesisTesting/mods_dir/DetGABAAB.mod";
