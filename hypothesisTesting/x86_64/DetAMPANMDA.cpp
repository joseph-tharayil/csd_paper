...
#define toggleVerbose toggleVerbose__DetAMPANMDA 
  ...
  if (nrn_point_prop_) {
   ...
   _ppvar = nrn_prop_datum_alloc(_mechtype, 6, _prop);
    ...
    assert(_nrn_mechanism_get_num_vars(_prop) == 35);
 	...
 	NMDA_ratio = _parm_default[10]; /* 0.71 */
 	synapseID = _parm_default[11]; /* 0 */
 	verboseLevel = _parm_default[12]; /* 0 */
 	conductance = _parm_default[13]; /* 0 */
  }
 	 assert(_nrn_mechanism_get_num_vars(_prop) == 35);
 	_nrn_mechanism_access_dparam(_prop) = _ppvar;
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 8;
    ...
    hoc_register_var(hoc_scdoub, hoc_vdoub, hoc_intfunc);
 	ivoc_help("help ?1 DetAMPANMDA /mnt/mydata/Documents/csdRevisions/csd_paper/hypothesisTesting/mods_dir/DetAMPANMDA.mod\n");
...
static void register_nmodl_text_and_filename(int mech_type) {
    const char* nmodl_filename = "/mnt/mydata/Documents/csdRevisions/csd_paper/hypothesisTesting/mods_dir/DetAMPANMDA.mod";
