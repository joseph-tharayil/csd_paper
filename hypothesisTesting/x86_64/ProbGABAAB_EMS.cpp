...
static constexpr auto number_of_floating_point_variables = 41;
namespace {
template <typename T>
...
#define toggleVerbose toggleVerbose__ProbGABAAB_EMS 
...
#define Nrrp _ml->template fpfield<10>(_iml)
...
#define selected_for_report _ml->template fpfield<13>(_iml)
#define selected_for_report_columnindex 13
#define GABAB_ratio _ml->template fpfield<14>(_iml)
#define GABAB_ratio_columnindex 14
#define conductance _ml->template fpfield<15>(_iml)
#define conductance_columnindex 15
#define i _ml->template fpfield<16>(_iml)
#define i_columnindex 16
#define i_GABAA _ml->template fpfield<17>(_iml)
#define i_GABAA_columnindex 17
#define i_GABAB _ml->template fpfield<18>(_iml)
#define i_GABAB_columnindex 18
#define g_GABAA _ml->template fpfield<19>(_iml)
#define g_GABAA_columnindex 19
#define g_GABAB _ml->template fpfield<20>(_iml)
#define g_GABAB_columnindex 20
#define g _ml->template fpfield<21>(_iml)
...
#define A_GABAA _ml->template fpfield<27>(_iml)
#define A_GABAA_columnindex 27
#define B_GABAA _ml->template fpfield<28>(_iml)
#define B_GABAA_columnindex 28
#define A_GABAB _ml->template fpfield<29>(_iml)
#define A_GABAB_columnindex 29
#define B_GABAB _ml->template fpfield<30>(_iml)
#define B_GABAB_columnindex 30
#define factor_GABAA _ml->template fpfield<31>(_iml)
#define factor_GABAA_columnindex 31
#define factor_GABAB _ml->template fpfield<32>(_iml)
#define factor_GABAB_columnindex 32
#define usingR123 _ml->template fpfield<33>(_iml)
#define usingR123_columnindex 33
#define DA_GABAA _ml->template fpfield<34>(_iml)
#define DA_GABAA_columnindex 34
#define DB_GABAA _ml->template fpfield<35>(_iml)
#define DB_GABAA_columnindex 35
#define DA_GABAB _ml->template fpfield<36>(_iml)
#define DA_GABAB_columnindex 36
#define DB_GABAB _ml->template fpfield<37>(_iml)
#define DB_GABAB_columnindex 37
...
#define _tsav _ml->template fpfield<40>(_iml)
#define _tsav_columnindex 40
...
static void nrn_alloc(Prop* _prop) {
  ...
  if (nrn_point_prop_) {
   ...
   _ppvar = nrn_prop_datum_alloc(_mechtype, 7, _prop);
    ...
    size_t const _iml{};
    assert(_nrn_mechanism_get_num_vars(_prop) == 41);
 	...
 	Nrrp = _parm_default[10]; /* 1 */
 	synapseID = _parm_default[11]; /* 0 */
 	verboseLevel = _parm_default[12]; /* 0 */
 	selected_for_report = _parm_default[13]; /* 0 */
 	GABAB_ratio = _parm_default[14]; /* 0 */
 	conductance = _parm_default[15]; /* 0 */
  }
 	 assert(_nrn_mechanism_get_num_vars(_prop) == 41);
 	_nrn_mechanism_access_dparam(_prop) = _ppvar;
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 hoc_register_parm_default(_mechtype, &_parm_default);
  ...
  register_nmodl_text_and_filename(_mechtype);
   ...
   _nrn_mechanism_register_data_fields(_mechtype,
                                       ...
                                       _nrn_mechanism_field<double>{"Nrrp"} /* 10 */,
                                       _nrn_mechanism_field<double>{"synapseID"} /* 11 */,
                                       _nrn_mechanism_field<double>{"verboseLevel"} /* 12 */,
                                       _nrn_mechanism_field<double>{"selected_for_report"} /* 13 */,
                                       _nrn_mechanism_field<double>{"GABAB_ratio"} /* 14 */,
                                       _nrn_mechanism_field<double>{"conductance"} /* 15 */,
                                       _nrn_mechanism_field<double>{"i"} /* 16 */,
                                       _nrn_mechanism_field<double>{"i_GABAA"} /* 17 */,
                                       _nrn_mechanism_field<double>{"i_GABAB"} /* 18 */,
                                       _nrn_mechanism_field<double>{"g_GABAA"} /* 19 */,
                                       _nrn_mechanism_field<double>{"g_GABAB"} /* 20 */,
                                       _nrn_mechanism_field<double>{"g"} /* 21 */,
                                       ...
                                       _nrn_mechanism_field<double>{"A_GABAA"} /* 27 */,
                                       _nrn_mechanism_field<double>{"B_GABAA"} /* 28 */,
                                       _nrn_mechanism_field<double>{"A_GABAB"} /* 29 */,
                                       _nrn_mechanism_field<double>{"B_GABAB"} /* 30 */,
                                       _nrn_mechanism_field<double>{"factor_GABAA"} /* 31 */,
                                       _nrn_mechanism_field<double>{"factor_GABAB"} /* 32 */,
                                       _nrn_mechanism_field<double>{"usingR123"} /* 33 */,
                                       _nrn_mechanism_field<double>{"DA_GABAA"} /* 34 */,
                                       _nrn_mechanism_field<double>{"DB_GABAA"} /* 35 */,
                                       _nrn_mechanism_field<double>{"DA_GABAB"} /* 36 */,
                                       _nrn_mechanism_field<double>{"DB_GABAB"} /* 37 */,
                                       _nrn_mechanism_field<double>{"v"} /* 38 */,
                                       _nrn_mechanism_field<double>{"_g"} /* 39 */,
                                       _nrn_mechanism_field<double>{"_tsav"} /* 40 */,
 ...
 pnt_receive_size[_mechtype] = 5;
    ...
    hoc_register_var(hoc_scdoub, hoc_vdoub, hoc_intfunc);
 	ivoc_help("help ?1 ProbGABAAB_EMS /mnt/mydata/Documents/csdRevisions/csd_paper/hypothesisTesting/mods_dir/ProbGABAAB_EMS.mod\n");
...
/*VERBATIM*/
   ...
   if ( _lves > 0.0 ) {
    ...
    double __primary = (A_GABAA + _lves / Nrrp * _args[1] * factor_GABAA) - __state;
 ...
 A_GABAA = A_GABAA + _lves / Nrrp * _args[1] * factor_GABAA ;
   ...
   if (nrn_netrec_state_adjust && !cvode_active_){
    ...
    double __primary = (B_GABAA + _lves / Nrrp * _args[1] * factor_GABAA) - __state;
 ...
 B_GABAA = B_GABAA + _lves / Nrrp * _args[1] * factor_GABAA ;
   ...
   if (nrn_netrec_state_adjust && !cvode_active_){
    ...
    double __primary = (A_GABAB + _lves / Nrrp * _args[2] * factor_GABAB) - __state;
 ...
 A_GABAB = A_GABAB + _lves / Nrrp * _args[2] * factor_GABAB ;
   ...
   if (nrn_netrec_state_adjust && !cvode_active_){
    ...
    double __primary = (B_GABAB + _lves / Nrrp * _args[2] * factor_GABAB) - __state;
...
static void register_nmodl_text_and_filename(int mech_type) {
    const char* nmodl_filename = "/mnt/mydata/Documents/csdRevisions/csd_paper/hypothesisTesting/mods_dir/ProbGABAAB_EMS.mod";
