...
#define toggleVerbose toggleVerbose__ProbAMPANMDA_EMS 
...
#define u0 _ml->template fpfield<4>(_iml)
#define u0_columnindex 4
#define Nrrp _ml->template fpfield<5>(_iml)
#define Nrrp_columnindex 5
#define synapseID _ml->template fpfield<6>(_iml)
#define synapseID_columnindex 6
#define verboseLevel _ml->template fpfield<7>(_iml)
#define verboseLevel_columnindex 7
#define selected_for_report _ml->template fpfield<8>(_iml)
#define selected_for_report_columnindex 8
#define NMDA_ratio _ml->template fpfield<9>(_iml)
#define NMDA_ratio_columnindex 9
#define conductance _ml->template fpfield<10>(_iml)
#define conductance_columnindex 10
...
#define unoccupied _ml->template fpfield<17>(_iml)
#define unoccupied_columnindex 17
#define occupied _ml->template fpfield<18>(_iml)
#define occupied_columnindex 18
#define tsyn _ml->template fpfield<19>(_iml)
#define tsyn_columnindex 19
#define u _ml->template fpfield<20>(_iml)
#define u_columnindex 20
#define next_delay _ml->template fpfield<21>(_iml)
#define next_delay_columnindex 21
#define A_AMPA _ml->template fpfield<22>(_iml)
#define A_AMPA_columnindex 22
#define B_AMPA _ml->template fpfield<23>(_iml)
#define B_AMPA_columnindex 23
#define A_NMDA _ml->template fpfield<24>(_iml)
#define A_NMDA_columnindex 24
#define B_NMDA _ml->template fpfield<25>(_iml)
#define B_NMDA_columnindex 25
#define factor_AMPA _ml->template fpfield<26>(_iml)
#define factor_AMPA_columnindex 26
#define factor_NMDA _ml->template fpfield<27>(_iml)
#define factor_NMDA_columnindex 27
#define mggate _ml->template fpfield<28>(_iml)
#define mggate_columnindex 28
#define usingR123 _ml->template fpfield<29>(_iml)
#define usingR123_columnindex 29
#define DA_AMPA _ml->template fpfield<30>(_iml)
#define DA_AMPA_columnindex 30
#define DB_AMPA _ml->template fpfield<31>(_iml)
#define DB_AMPA_columnindex 31
#define DA_NMDA _ml->template fpfield<32>(_iml)
#define DA_NMDA_columnindex 32
#define DB_NMDA _ml->template fpfield<33>(_iml)
...
#define _tsav _ml->template fpfield<36>(_iml)
...
#define tau_r_AMPA tau_r_AMPA_ProbAMPANMDA_EMS
 ...
 {"mg_ProbAMPANMDA_EMS", &mg_ProbAMPANMDA_EMS},
  ...
  if (nrn_point_prop_) {
   ...
   _ppvar = nrn_prop_datum_alloc(_mechtype, 7, _prop);
    ...
    assert(_nrn_mechanism_get_num_vars(_prop) == 37);
 	...
 	tau_d_AMPA = _parm_default[0]; /* 1.7 */
 	Use = _parm_default[1]; /* 1 */
 	Dep = _parm_default[2]; /* 100 */
 	Fac = _parm_default[3]; /* 10 */
 	u0 = _parm_default[4]; /* 0 */
 	Nrrp = _parm_default[5]; /* 1 */
 	synapseID = _parm_default[6]; /* 0 */
 	verboseLevel = _parm_default[7]; /* 0 */
 	selected_for_report = _parm_default[8]; /* 0 */
 	NMDA_ratio = _parm_default[9]; /* 0.71 */
 	conductance = _parm_default[10]; /* 0 */
  }
 	 assert(_nrn_mechanism_get_num_vars(_prop) == 37);
 	_nrn_mechanism_access_dparam(_prop) = _ppvar;
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 hoc_register_parm_default(_mechtype, &_parm_default);
  ...
  register_nmodl_text_and_filename(_mechtype);
   ...
   _nrn_mechanism_register_data_fields(_mechtype,
                                       ...
                                       _nrn_mechanism_field<double>{"u0"} /* 4 */,
                                       _nrn_mechanism_field<double>{"Nrrp"} /* 5 */,
                                       _nrn_mechanism_field<double>{"synapseID"} /* 6 */,
                                       _nrn_mechanism_field<double>{"verboseLevel"} /* 7 */,
                                       _nrn_mechanism_field<double>{"selected_for_report"} /* 8 */,
                                       _nrn_mechanism_field<double>{"NMDA_ratio"} /* 9 */,
                                       _nrn_mechanism_field<double>{"conductance"} /* 10 */,
                                       ...
                                       _nrn_mechanism_field<double>{"unoccupied"} /* 17 */,
                                       _nrn_mechanism_field<double>{"occupied"} /* 18 */,
                                       _nrn_mechanism_field<double>{"tsyn"} /* 19 */,
                                       _nrn_mechanism_field<double>{"u"} /* 20 */,
                                       _nrn_mechanism_field<double>{"next_delay"} /* 21 */,
                                       _nrn_mechanism_field<double>{"A_AMPA"} /* 22 */,
                                       _nrn_mechanism_field<double>{"B_AMPA"} /* 23 */,
                                       _nrn_mechanism_field<double>{"A_NMDA"} /* 24 */,
                                       _nrn_mechanism_field<double>{"B_NMDA"} /* 25 */,
                                       _nrn_mechanism_field<double>{"factor_AMPA"} /* 26 */,
                                       _nrn_mechanism_field<double>{"factor_NMDA"} /* 27 */,
                                       _nrn_mechanism_field<double>{"mggate"} /* 28 */,
                                       _nrn_mechanism_field<double>{"usingR123"} /* 29 */,
                                       _nrn_mechanism_field<double>{"DA_AMPA"} /* 30 */,
                                       _nrn_mechanism_field<double>{"DB_AMPA"} /* 31 */,
                                       _nrn_mechanism_field<double>{"DA_NMDA"} /* 32 */,
                                       _nrn_mechanism_field<double>{"DB_NMDA"} /* 33 */,
                                       _nrn_mechanism_field<double>{"v"} /* 34 */,
                                       _nrn_mechanism_field<double>{"_g"} /* 35 */,
                                       _nrn_mechanism_field<double>{"_tsav"} /* 36 */,
  ...
  hoc_register_prop_size(_mechtype, 37, 7);
 ...
 pnt_receive_size[_mechtype] = 5;
    ...
    hoc_register_var(hoc_scdoub, hoc_vdoub, hoc_intfunc);
 	ivoc_help("help ?1 ProbAMPANMDA_EMS /mnt/mydata/Documents/csdRevisions/csd_paper/hypothesisTesting/mods_dir/ProbAMPANMDA_EMS.mod\n");
...
static int toggleVerbose(_internalthreadargsproto_);
...
/*VERBATIM*/
   ...
   if ( _lves > 0.0 ) {
    ...
    double __primary = (A_AMPA + _lves / Nrrp * _args[1] * factor_AMPA) - __state;
 ...
 A_AMPA = A_AMPA + _lves / Nrrp * _args[1] * factor_AMPA ;
   ...
   if (nrn_netrec_state_adjust && !cvode_active_){
    ...
    double __primary = (B_AMPA + _lves / Nrrp * _args[1] * factor_AMPA) - __state;
 ...
 B_AMPA = B_AMPA + _lves / Nrrp * _args[1] * factor_AMPA ;
   ...
   if (nrn_netrec_state_adjust && !cvode_active_){
    ...
    double __primary = (A_NMDA + _lves / Nrrp * _args[2] * factor_NMDA) - __state;
 ...
 A_NMDA = A_NMDA + _lves / Nrrp * _args[2] * factor_NMDA ;
   ...
   if (nrn_netrec_state_adjust && !cvode_active_){
    ...
    double __primary = (B_NMDA + _lves / Nrrp * _args[2] * factor_NMDA) - __state;
...
static void register_nmodl_text_and_filename(int mech_type) {
    const char* nmodl_filename = "/mnt/mydata/Documents/csdRevisions/csd_paper/hypothesisTesting/mods_dir/ProbAMPANMDA_EMS.mod";
