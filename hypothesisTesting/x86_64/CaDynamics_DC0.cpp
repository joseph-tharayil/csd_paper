  ...
  Datum *_ppvar{};
   _ppvar = nrn_prop_datum_alloc(_mechtype, 7, _prop);
    ...
    assert(_nrn_mechanism_get_num_vars(_prop) == 8);
 	...
 	gamma = _parm_default[0]; /* 0.01 */
 	decay = _parm_default[1]; /* 70 */
 	 assert(_nrn_mechanism_get_num_vars(_prop) == 8);
 	_nrn_mechanism_access_dparam(_prop) = _ppvar;
 ...
 hoc_register_parm_default(_mechtype, &_parm_default);
  ...
  hoc_register_dparam_semantics(_mechtype, 5, "diam");
    ...
    hoc_register_var(hoc_scdoub, hoc_vdoub, hoc_intfunc);
 	ivoc_help("help ?1 CaDynamics_DC0 /mnt/mydata/Documents/csdRevisions/csd_paper/hypothesisTesting/mods_dir/CaDynamics_DC0.mod\n");
...
static void register_nmodl_text_and_filename(int mech_type) {
    const char* nmodl_filename = "/mnt/mydata/Documents/csdRevisions/csd_paper/hypothesisTesting/mods_dir/CaDynamics_DC0.mod";
